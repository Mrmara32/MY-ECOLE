...
const ENDPOINTS_CACHABLES = ['/eleves', '/personnel', '/classes', '/salles', '/paiements', '/absences', '/frais', '/settings', '/auth/me',
  ...
  '/absences-personnel', '/commandes', '/maintenance', '/transport/vehicules', '/transport/itineraires', '/transport/eleves',
  '/cours-revision', '/seances-cours', '/cantine/abonnements', '/cantine/menus'];
